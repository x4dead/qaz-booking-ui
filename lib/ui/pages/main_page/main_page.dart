...
final timeline = ValueNotifier(CalendarView.timelineMonth);
        ...
        appBar: CustomAppBar(title: 'QazBooking', action: (
          ValueListenableBuilder(
            ...
            builder: (context, value, child) {
              if (timeline.value == CalendarView.timelineMonth) {
          ...
          () {
            if (timeline.value == CalendarView.timelineMonth) {
              timeline.value = CalendarView.timelineDay;
              calendarController.view = CalendarView.timelineDay;
            } else {
              timeline.value = CalendarView.timelineMonth;
